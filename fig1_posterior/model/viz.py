...
def get_summ_stat_name(num):
    ...
    if num == 11: return r'$\Delta\phi_{PD\mathrm{-}LP}$'  # 'Phase gap PD-LP'
    if num == 12: return r'$\Delta\phi_{LP\mathrm{-}PY}$'  # 'Phase gap LP-PY'
    if num == 13: return r'$\phi_{LP}$'  # 'Phase LP'
    if num == 14: return r'$\phi_{PY}$'  # 'Phase PY'

...
def create_prior_q10(params, log=False):
    """
    Create the prior with Q10 values.
    """
    ...
    # tau_m
    if isinstance(params.Q10_tau_m, bool):
    ...
    use_tau_m_mem = np.asarray(params.Q10_tau_m)
    ...
    # tau_h
    if isinstance(params.Q10_tau_h, bool):
    ...
    use_tau_h_mem = np.asarray(params.Q10_tau_h)
    ...
    use_tau_CaBuff_mem = np.asarray(params.Q10_tau_CaBuff)
    ...
    membrane_and_sny_mins = np.concatenate((membrane_cond_mins, syn_dim_mins, gbar_q10_syn_used_mins, tau_q10_syn_used_mins, gbar_q10_mem_used_mins, tau_m_q10_mem_used_mins, tau_h_q10_mem_used_mins, tau_CaBuff_q10_mem_used_mins))
    membrane_and_sny_maxs = np.concatenate((membrane_cond_maxs, syn_dim_maxs, gbar_q10_syn_used_maxs, tau_q10_syn_used_maxs, gbar_q10_mem_used_maxs, tau_m_q10_mem_used_maxs, tau_h_q10_mem_used_maxs, tau_CaBuff_q10_mem_used_maxs))

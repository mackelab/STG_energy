...
path_to_data = (
    "simulation_data_Tube_MLslurm_cluster_no_noise/01_simulate_11deg/data/valid_"
)
...
path_to_data = (
    "simulation_data_Tube_MLslurm_cluster_no_noise/01_simulate_11deg_R2/data/valid_"
)
...
path_to_data = (
    "simulation_data_Tube_MLslurm_cluster_no_noise/01_simulate_11deg_R3/data/valid_"
)
...
theta = pd.concat((theta_r1, theta_r2, theta_r3.loc[:3_000_000]))
x = pd.concat((x_r1, x_r2, x_r3.loc[:3_000_000]))
seeds = np.concatenate((seeds_r1, seeds_r2, seeds_r3[:3_000_000]))

path_to_save = "simulation_data_Tube_MLslurm_cluster_no_noise/all_"
theta.to_pickle(

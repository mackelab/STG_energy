...
for _ in range(num_repeats):
    ...
    with open(path + "posterior_11deg_no_noise_obsnoise.pickle", "rb") as handle:
    ...
    path_to_data = "simulation_data_Tube_MLslurm_cluster_no_noise/simulate_11deg_R3_predictives_at_11deg_obsnoise/data/"

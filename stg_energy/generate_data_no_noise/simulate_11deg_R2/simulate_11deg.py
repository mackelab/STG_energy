...
# Transmit data:
# scp -r results/trained_neural_nets/inference/optimized_network.pickle mdeistler57@134.2.168.52:~/Documents/STG_energy/results/trained_neural_nets/inference/
...
# Get data back:
# scp -r mdeistler57@134.2.168.52:~/Documents/STG_energy/results/simulation_data_Tube_MLslurm_cluster/01_simulate_11deg_R2/data/* results/simulation_data_Tube_MLslurm_cluster/01_simulate_11deg_R2/data
...
for _ in range(num_repeats):
    ...
    with open(path + "optimized_network_no_noise.pickle", "rb") as handle:
    ...
    path_to_data = (
        "simulation_data_Tube_MLslurm_cluster_no_noise/01_simulate_11deg_R2/data/"
    )

...
path2 = "simulate_11deg_R3_predictives_at_11deg_bothnoise"
...
theta_close_pd.to_pickle(path1 + "/close_to_xo_circuit_parameters_bothnoise.pkl")
x_close_pd.to_pickle(path1 + "/close_to_xo_simulation_outputs_bothnoise.pkl")
np.save(path1 + "/close_to_xo_seeds_bothnoise.npy", seeds_close)

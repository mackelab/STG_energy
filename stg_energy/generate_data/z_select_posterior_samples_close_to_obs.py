...
path1 = "../../results/simulation_data_Tube_MLslurm_cluster/"
path2 = "simulate_11deg_R3_predictives_at_11deg"
...
theta_close_pd.to_pickle(path1 + "/close_to_xo_circuit_parameters.pkl")
x_close_pd.to_pickle(path1 + "/close_to_xo_simulation_outputs.pkl")
np.save(path1 + "/close_to_xo_seeds.npy", seeds_close)
